...
public class ObtainMUCChangNickIQ  extends IQ{
	...
	private String sendChangNick() {
       ...
       sb.append("<muc>"). append(StringUtils.escapeForXML(muc)).append("</muc>");
       sb.append("<nickname>").append(StringUtils.escapeForXML(nickname)).append("</nickname>");
       sb.append("</query>");
		return sb.toString();
	}
