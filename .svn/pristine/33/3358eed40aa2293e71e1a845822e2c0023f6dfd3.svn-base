...
public class ObtainMUCmemberProvider implements IQProvider{
	...
	public IQ parseIQ(XmlPullParser parser) throws Exception {
		...
		ObtainMUCmemberIQ getmember = new ObtainMUCmemberIQ();
		boolean done = false;
		while (!done) {
	   ...
	   private ObtainMUCmemberIQ.Item parseItem(XmlPullParser parser) throws Exception {
	        boolean done = false;
