...
public class Near extends IQ{
	...
	private final List<Item> nearItems = new ArrayList<Item>();
	...
	public void addNearItem(Item item) {
	...
	public Collection<Item> getNearItems() {
		synchronized (nearItems) {
			return Collections.unmodifiableList(new ArrayList<Item>(nearItems));
		}
	}
	...
	public static class Item{
		...
		public Item(String username, Double lat, Double lon) {
			super();
			this.username = username;
			this.lat = lat;
			this.lon = lon;
