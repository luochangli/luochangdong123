...
public class ObtainMUCmemberIQ extends IQ implements Serializable{
	...
	public static class Item implements Serializable{
		...
		public String toXML() {
			...
			sb.append("<item>").append("<jid>").append(StringUtils.escapeForXML(getJid()))
					.append("</jid>");
			sb.append("<nick>").append(StringUtils.escapeForXML(getNick())).append("</nick>");
			sb.append("<affiliation>").append(StringUtils.escapeForXML(getAffiliation())).append("</affiliation>")
					.append("</item>");
			return sb.toString();
