...
import com.weidi.view.sreenshot.CropImage;
import com.weidi.view.sreenshot.CropImageView;
...
public class CropImageActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		init();
		QApp.getInstance().addActivity(CropImageActivity.this);
	}
...
//		Log.i(TAG, "得到的图片的路径是 = " + mPath);
		...
		try {
			...
			if (mBitmap == null) {
				...
				ToastUtil.showShortToast(CropImageActivity.this, "没有找到图片");
				finish();
			} else {
		...
		if (isAutoSend) {
			ToastUtil.showShortToast(CropImageActivity.this, "图像处理中,请稍候...");
