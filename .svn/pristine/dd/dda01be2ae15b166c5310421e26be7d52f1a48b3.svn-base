 ...
 * @date 创建时间：2015-7-22 下午5:36:55
 * @Description 1.0 生成带图片的二维码 final String filePath =
 *              getFileRoot(MainActivity.this) + File.separator + "qr_" +
 *              System.currentTimeMillis() + ".jpg";
 *              //二维码图片较大时，生成图片、保存文件的时间可能较长，因此放在新线程中 new Thread(new Runnable() {
 * @Override public void run() { boolean success =
 *           QRCodeUtil.createQRImage(contentET.getText().toString().trim(),
 *           800, 800, addLogoCB.isChecked() ?
