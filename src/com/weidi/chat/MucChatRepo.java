		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					item.setCreatedatetime(StringUtils.parseDate(
							iq.getCrieatdatetime()).toString());
	...
	public void getMenbByIQ(final String muc) {
		...
		new XmppLoadThread(mContext) {
			...
			protected Object load() {
				ObtainMUCmemberIQ iq = IQOrder.getInstance()
						.obtainMUCGetmember(XmppUtil.getFullMUC(muc));
				return iq;
			}
		};
	}
