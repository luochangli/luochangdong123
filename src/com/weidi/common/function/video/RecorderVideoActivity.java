 ...
 * @date 创建时间：2015-6-16 下午3:35:57
 * @Description 1.0
 */
public class RecorderVideoActivity  extends FragmentActivity implements OnClickListener,
	...
	private boolean initCamera() {
		try {
			...
			Logger.e("video", "init Camera fail " + ex.getMessage());
			return false;
		}
		return true;
	}
							...
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									try {
										...
										Logger.e("video", "start preview fail "
												+ e1.getMessage());
									}
								}
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		try {
			...
			Logger.e("video", "start preview fail " + e1.getMessage());
		}
	}

	@Override
	public void surfaceDestroyed(SurfaceHolder arg0) {
		Logger.v("video", "surfaceDestroyed");
	...
	private void initRecorder() {
		...
		// 设置视频文件输出的路径
		localPath = FileUtil.getRecentChatPath()
	...
	public void onError(MediaRecorder mr, int what, int extra) {
		Logger.e("video", "recording onError:");
		stopRecording();
		Toast.makeText(this,
