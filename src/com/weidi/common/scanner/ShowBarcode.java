...
public class ShowBarcode extends BaseActivity {
   ...
   public static final String filePath = FileUtil.getRecentChatPath() + Const.USER_NAME
			+ ".jpg";
	@Override
	...
	private void createBarcode(final String filePath) {
		new Thread(new Runnable() {
			...
			public void run() {
				...
				Bitmap mine = ImageCache.getInstance().get(Const.USER_NAME);
				boolean success = CreateBarcode.createQRImage(XmppUtil.getFullUsername(Const.USER_NAME),
						800, 800, mine, filePath);
