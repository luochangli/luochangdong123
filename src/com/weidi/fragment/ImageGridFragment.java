...
import com.weidi.BuildConfig;
import com.weidi.R;
import com.weidi.common.DateUtil;
import com.weidi.common.function.video.ImageCache;
import com.weidi.common.function.video.ImageResizer;
import com.weidi.common.function.video.RecorderVideoActivity;
import com.weidi.common.function.video.RecyclingImageView;
import com.weidi.common.function.video.Utils;
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			...
			if(position==0)
			{
				...
				holder.tvDur.setText(DateUtil.date2Str(entty.duration, "mm:ss"));
				holder.tvSize.setText(VideoThumbnail.bytes2kb(entty.size));
