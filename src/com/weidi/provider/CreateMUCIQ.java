...
public class CreateMUCIQ extends IQ{
  ...
  public CreateMUCIQ(){
	...
	private String getSet() {
       ...
       sb.append("<name>"). append(StringUtils.escapeForXML(name)).append("</name>");
       sb.append("<description>").append(StringUtils.escapeForXML(description)).append("</description>");
       sb.append("<ownernick>").append(StringUtils.escapeForXML(ownernick)).append("</ownernick>");
       sb.append("</query>");
